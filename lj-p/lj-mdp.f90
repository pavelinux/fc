...
USE VARIABLES
IMPLICIT NONE
OPEN(10,FILE='lj-mdp.log',STATUS='UNKNOWN',ACTION='WRITE')
WRITE(10,*) 'TIEMPO DE CALCULO: ', TF - TI
WRITE(10,*) 'NUMERO DE PARTICULAS:', N
WRITE(10,*) 'NUMERO DE PASOS DE INTEGRACION:', NPASOS
CLOSE(10)
